...
Version  : 5.16.4
Release  : 36
URL      : https://github.com/KDE/kwin/archive/v5.16.4/kwin-5.16.4.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.16.4/kwin-5.16.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564508681
mkdir -p clr-build
pushd clr-build
