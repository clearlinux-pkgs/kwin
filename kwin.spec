...
Version  : 6.1.4
Release  : 142
URL      : https://download.kde.org/stable/plasma/6.1.4/kwin-6.1.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.4/kwin-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/kwin-6.1.4.tar.xz.sig
...
%setup -q -n kwin-6.1.4
cd %{_builddir}/kwin-6.1.4
pushd ..
cp -a kwin-6.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723148489
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcmkwincommon.so.6.1.4
/V3/usr/lib64/libkwin.so.6.1.4
...
/V3/usr/lib64/qt6/plugins/kwin/effects/configs/kwin_colorblindnesscorrection_config.so
...
/V3/usr/lib64/qt6/plugins/org.kde.kdecoration2.kcm/kcm_auroraedecoration.so
/V3/usr/lib64/qt6/plugins/org.kde.kdecoration2/org.kde.kwin.aurorae.so
...
/usr/lib64/libkcmkwincommon.so.6.1.4
/usr/lib64/libkwin.so.6
/usr/lib64/libkwin.so.6.1.4
...
/usr/lib64/qt6/plugins/kwin/effects/configs/kwin_colorblindnesscorrection_config.so
...
/usr/lib64/qt6/plugins/org.kde.kdecoration2.kcm/kcm_auroraedecoration.so
/usr/lib64/qt6/plugins/org.kde.kdecoration2/org.kde.kwin.aurorae.so
