...
Source0  : https://download.kde.org/stable/plasma/6.1.3/kwin-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kwin-6.1.3.tar.xz.sig
...
%setup -q -n kwin-6.1.3
cd %{_builddir}/kwin-6.1.3
pushd ..
cp -a kwin-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721162851
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcmkwincommon.so.6.1.3
/V3/usr/lib64/libkwin.so.6.1.3
...
/usr/lib64/libkcmkwincommon.so.6.1.3
/usr/lib64/libkwin.so.6
/usr/lib64/libkwin.so.6.1.3
