...
Version  : 6.1.5
Release  : 144
URL      : https://download.kde.org/stable/plasma/6.1.5/kwin-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/kwin-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/kwin-6.1.5.tar.xz.sig
...
%setup -q -n kwin-6.1.5
cd %{_builddir}/kwin-6.1.5
pushd ..
cp -a kwin-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726002004
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcmkwincommon.so.6.1.5
/V3/usr/lib64/libkwin.so.6.1.5
...
/usr/lib64/libkcmkwincommon.so.6.1.5
/usr/lib64/libkwin.so.6
/usr/lib64/libkwin.so.6.1.5
