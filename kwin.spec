...
Source0  : https://download.kde.org/stable/plasma/6.3.5/kwin-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/kwin-6.3.5.tar.xz.sig
...
%setup -q -n kwin-6.3.5
cd %{_builddir}/kwin-6.3.5
pushd ..
cp -a kwin-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747171439
mkdir -p clr-build
pushd clr-build
...
/usr/include/kwin/wayland/colormanagement_v1.h
...
/usr/include/kwin/wayland/qwayland-server-color-management-v1.h
...
/usr/include/kwin/wayland/wayland-color-management-v1-server-protocol.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcmkwincommon.so.6.3.5
/V3/usr/lib64/libkwin.so.6.3.5
...
/usr/lib64/libkcmkwincommon.so.6.3.5
/usr/lib64/libkwin.so.6
/usr/lib64/libkwin.so.6.3.5
