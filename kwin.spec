...
Version  : 5.14.5
Release  : 16
URL      : https://github.com/KDE/kwin/archive/v5.14.5.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.14.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546966554
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/qt5/plugins/kwin/effects/configs/kwin_scale_config.so
