...
Version  : 5.14.2
Release  : 9
URL      : https://github.com/KDE/kwin/archive/v5.14.2.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.14.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540462771
mkdir -p clr-build
pushd clr-build
%cmake ..
