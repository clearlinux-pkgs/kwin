...
Version  : 6.3.4
Release  : 158
URL      : https://download.kde.org/stable/plasma/6.3.4/kwin-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/kwin-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/kwin-6.3.4.tar.xz.sig
...
%setup -q -n kwin-6.3.4
cd %{_builddir}/kwin-6.3.4
pushd ..
cp -a kwin-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744149141
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcmkwincommon.so.6.3.4
/V3/usr/lib64/libkwin.so.6.3.4
...
/usr/lib64/libkcmkwincommon.so.6.3.4
/usr/lib64/libkwin.so.6
/usr/lib64/libkwin.so.6.3.4
