...
Version  : 5.13.3
Release  : 1
URL      : https://github.com/KDE/kwin/archive/v5.13.3.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.13.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532460794
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
