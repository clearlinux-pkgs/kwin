...
Version  : 5.16.1
Release  : 33
URL      : https://github.com/KDE/kwin/archive/v5.16.1/kwin-5.16.1.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.16.1/kwin-5.16.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1560872310
mkdir -p clr-build
pushd clr-build
