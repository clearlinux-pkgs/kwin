...
Version  : 5.17.0
Release  : 39
URL      : https://github.com/KDE/kwin/archive/v5.17.0/kwin-5.17.0.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.17.0/kwin-5.17.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571161608
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwin-5.17.0/COPYING %{buildroot}/usr/share/package-licenses/kwin/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kwin-5.17.0/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kwin/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
