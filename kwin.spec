...
Version  : 5.15.0
Release  : 19
URL      : https://github.com/KDE/kwin/archive/v5.15.0.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.15.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549985459
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
