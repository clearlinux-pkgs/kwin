...
Version  : 5.17.2
Release  : 41
URL      : https://github.com/KDE/kwin/archive/v5.17.2/kwin-5.17.2.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.17.2/kwin-5.17.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572440427
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwin-5.17.2/COPYING %{buildroot}/usr/share/package-licenses/kwin/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kwin-5.17.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kwin/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
