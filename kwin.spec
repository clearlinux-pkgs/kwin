...
Version  : 5.16.3
Release  : 35
URL      : https://github.com/KDE/kwin/archive/v5.16.3/kwin-5.16.3.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.16.3/kwin-5.16.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562729625
mkdir -p clr-build
pushd clr-build
