...
Version  : 5.15.5
Release  : 29
URL      : https://github.com/KDE/kwin/archive/v5.15.5/kwin-5.15.5.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.15.5/kwin-5.15.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557243359
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
