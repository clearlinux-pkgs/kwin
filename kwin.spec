...
Version  : 5.15.2
Release  : 21
URL      : https://github.com/KDE/kwin/archive/v5.15.2.tar.gz
Source0  : https://github.com/KDE/kwin/archive/v5.15.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551202373
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
